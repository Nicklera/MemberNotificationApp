...
class FollowUpCategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        //get custom fields
        return view('follow_up_category.create', compact(''));
    }
    ...
    public function show(FollowUpCategory $follow_up_category)
    {
    ...
    public function edit(FollowUpCategory $follow_up_category)
    {
