...
class EventController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('event.data', compact('events', 'calendars', 'locations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('featured_image')) {
            ...
            if ($validator->fails()) {
                ...
                $event->photo = $request->file('featured_image')->getClientOriginalName();
    ...
    public function attender(Event $event)
    {
        if (!Sentinel::hasAccess('events.view')) {
            Flash::warning("Permission Denied");
            return redirect('/');
    ...
    public function get_volunteer( Volunteer $volunteer)
    {
        $json = [];
    ...
    public function volunteer_detail(Volunteer $volunteer)
    {
    ...
    public function edit(Event $event)
    {
        ...
        return view('event.edit', compact('event', 'locations', 'calendars'));
    }
